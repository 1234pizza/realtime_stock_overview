...
class DataSource:
    ...
    def get_velocity_data(_self):
        try:
            ...
            # Period "2d" ensures we have enough 1m bars for a 14-period RSI + 60m trend
            ...
            if data_1m.empty or data_1d.empty: return pd.DataFrame()
            ...
            for ticker in all_tickers:
                try:
                    ...
                    # RSI Calculation (Current 1-minute RSI)
                    rsi_values = _self.calculate_rsi(df_1m['Close'])
